	...
	internal class Startup : MonoBehaviour
	{
		private void Start()
		{
			...
			try
			{
				...
				{
					String msg = CheckTweakScaleWatchDog(kspMajor, kspMinor);
					if ( null != msg )
		...
		private String CheckTweakScaleWatchDog(int kspMajor, int kspMinor)
		{
			...
			if (0 != redist.Count()) return "There's no 999_Scale_Redist.dll on this KSP instalment besides being needed! You need to install 999_Scale_Redist.dll into GameData!!";
			if (1 != redist.Count()) return "There're more than one 999_Scale_Redist.dll on this KSP instalment! Please delete all but the one on GameData!";
			return null;
		}
	}
}
