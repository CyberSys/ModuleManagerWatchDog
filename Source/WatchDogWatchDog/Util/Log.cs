...
namespace WatchDogWatchDog
{
	public static class Log
	{
		...
		{
			UnityEngine.Debug.LogFormat("[WatchDogWatchDog] " + msg, @params);
		}

		internal static void info(string msg, params object[] @params)
		{
			UnityEngine.Debug.LogFormat("[WatchDogWatchDog] INFO: " + msg, @params);
		}

		internal static void detail(string msg, params object[] @params)
		{
			UnityEngine.Debug.LogFormat("[WatchDogWatchDog] DETAIL: " + msg, @params);
		}

		internal static void error(string msg, params object[] @params)
		{
			UnityEngine.Debug.LogErrorFormat("[WatchDogWatchDog] ERROR: " + msg, @params);
		}
