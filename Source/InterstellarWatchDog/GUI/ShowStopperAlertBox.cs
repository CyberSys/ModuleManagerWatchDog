...
namespace InterstellartWatchDog.GUI
{
	internal static class ShowStopperAlertBox
	{
		private static readonly string AMSG = @"to get instructions about how to Download and Install (correctly) Interstellar.";
		...
		internal static void Show(string msg)
		{
			KSPe.Common.Dialogs.ShowStopperAlertBox.Show(
				msg,
				AMSG,
				() => { Application.OpenURL("https://forum.kerbalspaceprogram.com/index.php?/topic/172026-*/"); Application.Quit(); }
			);
